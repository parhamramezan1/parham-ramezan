  ...
  return (
    <section className="bg-black text-white py-12 px-4">
      ...
      <div className="max-w-4xl mx-auto bg-zinc-900 p-6 rounded-2xl border border-zinc-700 shadow-lg">
        ...
        <p className="text-lg leading-8 mb-4">
          وی در شبکه‌های یک، دو، سه، آموزش و ورزش فعالیت داشته و در پروژه‌های مختلفی چون فیلم‌های «رهایی»، «کارآموز»، «حسرت» و...، همچنین سریال‌هایی نظیر «عاشقانه»، «سه پنج دو»، «آشپزباشی» و دیگر آثار تلویزیونی نقش‌آفرینی کرده است. از دیگر پروژه‌های شاخص او می‌توان به برنامه‌هایی مانند «دورهمی» و «تا نیایش» اشاره کرد.
        </p>
        <p className="text-lg leading-8 mb-4">
